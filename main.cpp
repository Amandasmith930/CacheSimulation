...
void readTraceFile(const string& fileName, int& hits, int& misses, int& bytesPerBlock, int& numSets) {
    ...
    ifstream inFile ("cmake-build-debug/tests/test1.txt");
...
int main() {
   string line;
//    ifstream myfile ("cmake-build-debug/tests/test1.txt");
//    myfile.open("tests/test1.txt");
//    if (myfile.is_open())
//    {
...
//    //string fileName = "gcc.trace";
    string fileName = "cmake-build-debug/tests/test1.txt";
